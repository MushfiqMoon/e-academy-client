    ...
    return (
        <div className="servises py-5 bg-light">
            <Container>
                ...
                <Row className='py-5'>
                    <Col md={4} sm={12}>
                        <div className="single-features-box without-padding pe-5">
                            <div className="icon"><FaBrain className='fs-1 txt-color-two mb-4' /></div>
                    ...
                    <Col md={4} sm={12}>
                        <div className="single-features-box without-padding pe-5">
                            <div className="icon"><FaDesktop className='fs-1 txt-color-two mb-4' /></div>
                    ...
                    <Col md={4} sm={12}>
                        <div className="single-features-box without-padding pe-5">
                            <div className="icon"><FaRegCheckSquare className='fs-1 txt-color-two mb-4' /></div>
                            <h4 className='fw-bold'>Learn the Latest Skills</h4>
                            <p>There are many variations of passages of learnings are available, but the majority have suffered alteration.</p>
                            <Link to='/courses' className='fw-bold txt-color-one'>Explore</Link>
                        </div>
